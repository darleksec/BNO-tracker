...
class BNOAdvancedTracker:
    ...
    def setup_ui(self):
        ...
        ttk.Button(trip_frame, text="Edit", command=self.load_edit).grid(row=0, column=5)
        ttk.Button(trip_frame, text="Delete", command=self.delete_trip).grid(row=0, column=6)
